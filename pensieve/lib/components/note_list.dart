// filepath: lib/components/note_list_item.dart
...
class NoteListItemState extends State<NoteListItem> {
  ...
  return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0), // Añadir padding vertical
      child: Container(
        ...
        child: Card(
          elevation: 0,
          color: Colors.transparent, // Use note color
          child: Padding(
